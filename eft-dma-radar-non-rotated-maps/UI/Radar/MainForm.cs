using DarkModeForms;
using eft_dma_radar_non_rotated_maps.Features.MemoryWrites.UI;
using eft_dma_radar_non_rotated_maps.Tarkov.API;
using eft_dma_radar_non_rotated_maps.Tarkov.EFTPlayer;
using eft_dma_radar_non_rotated_maps.Tarkov.EFTPlayer.Plugins;
using eft_dma_radar_non_rotated_maps.Tarkov.Features;
using eft_dma_radar_non_rotated_maps.Tarkov.Features.MemoryWrites;
using eft_dma_radar_non_rotated_maps.Tarkov.Features.MemoryWrites.Patches;
using eft_dma_radar_non_rotated_maps.Tarkov.GameWorld;
using eft_dma_radar_non_rotated_maps.Tarkov.GameWorld.Exits;
using eft_dma_radar_non_rotated_maps.Tarkov.GameWorld.Explosives;
using eft_dma_radar_non_rotated_maps.Tarkov.Loot;
using eft_dma_radar_non_rotated_maps.Tarkov.WebRadar;
using eft_dma_radar_non_rotated_maps.UI.ColorPicker;
using eft_dma_radar_non_rotated_maps.UI.ColorPicker.ESP;
using eft_dma_radar_non_rotated_maps.UI.ColorPicker.Radar;
using eft_dma_radar_non_rotated_maps.UI.ESP;
using eft_dma_radar_non_rotated_maps.UI.Hotkeys;
using eft_dma_radar_non_rotated_maps.UI.LootFilters;
using eft_dma_radar_non_rotated_maps.UI.Misc;
using eft_dma_radar_non_rotated_maps.UI.SKWidgetControl;
...
using System.Timers;
using static eft_dma_radar_non_rotated_maps.UI.Hotkeys.HotkeyManager;
using static eft_dma_radar_non_rotated_maps.UI.Hotkeys.HotkeyManager.HotkeyActionController;
