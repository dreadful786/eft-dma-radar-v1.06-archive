...
namespace eft_dma_radar_non_rotated_maps
{
    internal static class Program
    {
        internal const string Name = "EFT DMA Radar Non Rotated Maps";
