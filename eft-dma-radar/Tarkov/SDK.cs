namespace SDK
{
	public readonly partial struct ClassNames
	{
		...
		{
			public const string Value = @"0.16.9.0.38703";
		}
		...
		{
			public const uint ClassName_ClassToken = 0x2001C6F; // MDToken
			public const uint MethodName_MethodToken = 0x600B746; // MDToken
			public const string ClassName = @"\uEA07";
		...
		{
			public const uint ClassName_ClassToken = 0x2002954; // MDToken
			public const uint BaseCalculationMethod_MethodToken = 0x600FEFE; // MDToken
			public const uint SpeedPenaltyPercent_MethodToken = 0x600FEFF; // MDToken
			public const uint MousePenalty_MethodToken = 0x600FF01; // MDToken
			public const uint WeaponErgonomicPenalty_MethodToken = 0x600FF03; // MDToken
		...
		{
			public const uint ClassName_ClassToken = 0x2002B6D; // MDToken
			public const uint ShowOwnDogTagMethod_MethodToken = 0x601098C; // MDToken
			public const uint KeybindFromAnywhereMethodB_MethodToken = 0x6010990; // MDToken
			public const uint KeybindFromAnywhereMethodA_MethodToken = 0x6010992; // MDToken
		...
		{
			public const uint ClassName_ClassToken = 0x2001E28; // MDToken
			public const string ClassName = @"\uEA48";
		}

		public readonly partial struct LayerManager
		{
			public const uint ClassName_ClassToken = 0x20008CD; // MDToken
			public const string ClassName = @"\uE3DF";
		}

		public readonly partial struct BallisticLayerManager
		{
			public const uint ClassName_ClassToken = 0x2003099; // MDToken
			public const string ClassName = @"\uF165";
		}
		...
		{
			public const uint ClassName_ClassToken = 0x20005A0; // MDToken
			public const uint MethodName_MethodToken = 0x6002ACE; // MDToken
		...
		{
			public const uint ClassName_ClassToken = 0x200279D; // MDToken
			public const uint MethodName_MethodToken = 0x600F72B; // MDToken
	...
	public readonly partial struct Offsets
	{
		...
		public readonly partial struct ItemTemplate
		{
			...
			public const uint ConflictingItems = 0x40; // System.String[]
		...
		{
			public const uint OpticCalibrationPoints = 0x18; // UnityEngine.Vector3[]
			public const uint _template = 0x20; // -.\uEE6C
			public const uint ScopesCurrentCalibPointIndexes = 0x28; // System.Int32[]
